...
func NewSecretProviderClass(scope constructs.Construct, id *string, props *SecretProviderClassProps) SecretProviderClass {
	...
	if err := validateNewSecretProviderClassParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func SecretProviderClass_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateSecretProviderClass_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func SecretProviderClass_IsConstruct(x interface{}) *bool {
	...
	if err := validateSecretProviderClass_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SecretProviderClass_Manifest(props *SecretProviderClassProps) interface{} {
	...
	if err := validateSecretProviderClass_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func SecretProviderClass_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateSecretProviderClass_OfParameters(c); err != nil {
		panic(err)
	}
