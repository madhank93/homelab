...
import (
	...
	_init_ "github.com/madhank93/homelab/workloads/imports/grafana/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/cdk8s-team/cdk8s-core-go/cdk8s/v2"
	"github.com/madhank93/homelab/workloads/imports/grafana/internal"
)
...
func (j *jsiiProxy_Grafana) Helm() cdk8s.Helm {
...
func (j *jsiiProxy_Grafana)SetHelm(val cdk8s.Helm) {
...
func (g *jsiiProxy_Grafana) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
