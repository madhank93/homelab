...
func KubeComponentStatusList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeComponentStatusList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeComponentStatusList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
