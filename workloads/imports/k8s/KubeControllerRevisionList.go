...
func KubeControllerRevisionList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeControllerRevisionList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeControllerRevisionList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
