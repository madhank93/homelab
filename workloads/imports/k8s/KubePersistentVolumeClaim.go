...
func KubePersistentVolumeClaim_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubePersistentVolumeClaim_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubePersistentVolumeClaim) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
