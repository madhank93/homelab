...
func KubePersistentVolumeList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubePersistentVolumeList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubePersistentVolumeList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
