...
func KubeConfigMapList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeConfigMapList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeConfigMapList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
