...
func KubePersistentVolumeClaimList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubePersistentVolumeClaimList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubePersistentVolumeClaimList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
