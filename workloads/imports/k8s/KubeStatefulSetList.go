...
func KubeStatefulSetList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeStatefulSetList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeStatefulSetList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
