...
func KubeStorageClassList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeStorageClassList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeStorageClassList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
