...
func KubeCsiStorageCapacityList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeCsiStorageCapacityList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeCsiStorageCapacityList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
