...
func KubeControllerRevision_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeControllerRevision_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeControllerRevision) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
