...
type Mutation struct {
	...
	ApplyConfiguration *ApplyConfiguration `field:"optional" json:"applyConfiguration" yaml:"applyConfiguration"`
	...
	JsonPatch *JsonPatch `field:"optional" json:"jsonPatch" yaml:"jsonPatch"`
}
