...
func KubePodTemplateList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubePodTemplateList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubePodTemplateList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
