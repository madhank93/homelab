...
func KubeVolumeAttachmentList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeVolumeAttachmentList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeVolumeAttachmentList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
