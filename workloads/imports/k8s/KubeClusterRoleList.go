...
func KubeClusterRoleList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeClusterRoleList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeClusterRoleList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
