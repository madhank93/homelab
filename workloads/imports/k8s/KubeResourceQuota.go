...
func KubeResourceQuota_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeResourceQuota_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeResourceQuota) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
