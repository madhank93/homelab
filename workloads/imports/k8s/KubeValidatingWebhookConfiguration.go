...
func KubeValidatingWebhookConfiguration_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeValidatingWebhookConfiguration_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeValidatingWebhookConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
