...
func KubeNamespaceList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeNamespaceList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeNamespaceList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
