...
func KubeValidatingWebhookConfigurationList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeValidatingWebhookConfigurationList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeValidatingWebhookConfigurationList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
