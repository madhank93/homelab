...
func KubeClusterRoleBinding_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeClusterRoleBinding_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeClusterRoleBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
