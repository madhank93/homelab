...
func KubeEndpointSlice_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeEndpointSlice_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeEndpointSlice) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
