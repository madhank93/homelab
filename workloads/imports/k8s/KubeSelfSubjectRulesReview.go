...
func KubeSelfSubjectRulesReview_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeSelfSubjectRulesReview_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeSelfSubjectRulesReview) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
