...
func KubeLimitRangeList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeLimitRangeList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KubeLimitRangeList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
