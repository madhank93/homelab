...
func NewKubeApiServiceList(scope constructs.Construct, id *string, props *KubeApiServiceListProps) KubeApiServiceList {
	...
	if err := validateNewKubeApiServiceListParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeApiServiceList_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeApiServiceList_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeApiServiceList_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeApiServiceList_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeApiServiceList_Manifest(props *KubeApiServiceListProps) interface{} {
	...
	if err := validateKubeApiServiceList_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeApiServiceList_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeApiServiceList_OfParameters(c); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KubeApiServiceList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
