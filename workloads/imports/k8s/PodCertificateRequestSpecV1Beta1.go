...
type PodCertificateRequestSpecV1Beta1 struct {
	...
	StubPkcs10Request *string `field:"required" json:"stubPkcs10Request" yaml:"stubPkcs10Request"`
	...
	PkixPublicKey *string `field:"optional" json:"pkixPublicKey" yaml:"pkixPublicKey"`
	...
	ProofOfPossession *string `field:"optional" json:"proofOfPossession" yaml:"proofOfPossession"`
