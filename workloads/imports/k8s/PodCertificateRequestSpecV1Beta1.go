...
type PodCertificateRequestSpecV1Beta1 struct {
	...
	UnverifiedUserAnnotations *map[string]*string `field:"optional" json:"unverifiedUserAnnotations" yaml:"unverifiedUserAnnotations"`
}
