...
func NewKubeDaemonSet(scope constructs.Construct, id *string, props *KubeDaemonSetProps) KubeDaemonSet {
	...
	if err := validateNewKubeDaemonSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeDaemonSet_IsApiObject(o interface{}) *bool {
	...
	if err := validateKubeDaemonSet_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDaemonSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeDaemonSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeDaemonSet_Manifest(props *KubeDaemonSetProps) interface{} {
	...
	if err := validateKubeDaemonSet_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeDaemonSet_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeDaemonSet_OfParameters(c); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KubeDaemonSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
