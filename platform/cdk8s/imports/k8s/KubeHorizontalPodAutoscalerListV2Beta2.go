...
func KubeHorizontalPodAutoscalerListV2Beta2_IsApiObject(o interface{}) *bool {
	_init_.Initialize()

	if err := validateKubeHorizontalPodAutoscalerListV2Beta2_IsApiObjectParameters(o); err != nil {
		panic(err)
	}
	var returns *bool
