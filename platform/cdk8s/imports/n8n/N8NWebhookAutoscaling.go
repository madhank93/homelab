...
type N8NWebhookAutoscaling struct {
	Behavior *N8NWebhookAutoscalingBehavior `field:"required" json:"behavior" yaml:"behavior"`
	...
	Metrics *[]*N8NWebhookAutoscalingMetrics `field:"required" json:"metrics" yaml:"metrics"`
